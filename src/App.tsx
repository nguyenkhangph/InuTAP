...
const App: React.FC = () => {
      ...
      <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-[calc(100%-2rem)] max-w-xl bg-[#272a2f] flex justify-around items-center z-50 rounded-3xl text-xs">
        <Link
          ...
          className={`text-center w-1/5 m-1 p-2 rounded-2xl ${
            location.pathname === "/"
              ? "bg-[#1c1f24] text-white border-2 border-[#f3ba2f]"
              : "text-[#85827d]"
          }`}
        >
        ...
        <Link
          to="/luckyspin"
          className={`text-center w-1/5 m-1 p-2 rounded-2xl ${
            location.pathname === "/luckyspin"
              ? "bg-[#1c1f24] text-white border-2 border-[#f3ba2f]"
              : "text-[#85827d]"
          }`}
        >
          <Coins className="w-8 h-8 mx-auto" />
          <p className="mt-1">Lucky Spin</p>
        </Link>
        <Link
          to="/airdrop"
          className={`text-center w-1/5 m-1 p-2 rounded-2xl ${
  ...
  return (
    <Router>
      <div className="bg-black flex flex-col items-center justify-center h-screen text-white font-bold">
                ...
                <div className="w-full bg-black text-white h-screen font-bold flex flex-col max-w-xl">
                  ...
                  <div className="px-4 z-10">
                    <div className="flex items-center space-x-2 pt-4">
                      ...
                      <div>
                        <p className="text-sm">Account_1</p>
                      </div>
                    </div>
